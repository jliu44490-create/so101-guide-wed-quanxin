...
export default function SettingsPage() {
  ...
  const t = isJa
    ? {
        title: 'アカウント設定',
        subtitle: 'アバター・ユーザー名・アカウント情報を管理します。',
        profile: 'プロフィール',
        changeAvatar: 'アバターを変更',
        avatarHint: 'JPG または PNG、3MB 以下',
        username: 'ユーザー名',
        usernamePh: '名前を入力',
        bio: '自己紹介',
        bioPh: '一言で自己紹介（任意）',
        ...
        plusNote: 'すべての講座と詳細ドキュメントを永久に利用できます。',
        companion: 'AI 学習パートナー',
        companionTitle: 'サイト全体で AI 学習パートナーを有効化',
        companionDesc: '質問への回答や補足解説を行い、ドキュメントでも「解説」してくれます。AI の 1 日の利用枠を消費します。いつでもオフにできます。',
        companionAria: 'AI 学習パートナーの切り替え',
        changePw: 'パスワード変更',
        newPw: '新しいパスワード',
        ...
        companionOff: 'AI 学習パートナーをオフにしました',
        companionOn: 'AI 学習パートナーを有効化しました。サイト全体で付き添います〜',
        pickImage: '画像ファイルを選択してください',
        imgTooBig: '画像は 3MB 以下にしてください',
