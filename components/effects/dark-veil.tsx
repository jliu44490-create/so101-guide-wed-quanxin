...
// @ts-nocheck — vendored reactbits WebGL shader; intentionally skips TS checks
'use client'

/**
 * Dark Veil — flowing CPPN color field (reactbits), rendered with the lightweight
 * ogl WebGL wrapper (no three.js). Used as the site-wide backdrop behind the
 * logged-in pages via <SiteBackground>. Opaque output, so it's dimmed + scrimmed
 * by its wrapper to stay quiet behind content.
 */
